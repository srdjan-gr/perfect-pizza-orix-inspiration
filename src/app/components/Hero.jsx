...
import HeroImg from "../../../public/img/hero-nobg.png";
import { IoIosArrowRoundForward } from "react-icons/io";

const Hero = () => {
  return (
    <section className="w-full max-w-[1440px] m-auto">
      <div className="m-auto flex justify-between h-[740px] bg-gradient-to-r from-pizza_green-300/30 to-pizza_orange-400/30 rounded-3xl">
